...
public class ReporteLibrosPDF1 extends Conexion {
  ...
  public void genReport(){
       ...
       try{
           ...
           JasperReport report = JasperCompileManager.compileReport(getClass().getResource("/reportes/Consulta4_examen.jrxml").getPath());
