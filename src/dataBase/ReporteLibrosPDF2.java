...
public class ReporteLibrosPDF2 extends Conexion {
  ...
  public void genReport(){
       ...
       try{
           ...
           JasperReport report = JasperCompileManager.compileReport(getClass().getResource("/reportes/Consulta5_examen.jrxml").getPath());
