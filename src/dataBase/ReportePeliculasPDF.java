...
public class ReportePeliculasPDF extends Conexion {
  ...
  public void genReport(){
       ...
       try{
           ...
           JasperReport report = JasperCompileManager.compileReport(getClass().getResource("/reportes/Peliculas.jrxml").getPath());
