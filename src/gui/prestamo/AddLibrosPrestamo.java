...
public class AddLibrosPrestamo extends javax.swing.JDialog {
    ...
    /**
     * Creates new form AddLibroPrestamo
     * @param parent
     * @param modal
     */
    public AddLibrosPrestamo (java.awt.Frame parent, boolean modal) {
        ...
        initComponents();
        // Crea el dao para consultar las ventanas
    ...
    private void llenaTabla(){        
        // Consulta los libros y lo guarda en un arreglo
        // consulta los datos de los libros
        Libros_Lista = LibroDAO.getLibrosByTitleDesc(txtFiltro.getText().trim());
        // Titulos de la tabla
        ...
        int[][] cellSize = {{0,0},
                            {1,305}};
        /*
            Metodo que llena las tablas, recibe la tabla, los datos, los titulos, la alineación y el tamaño de las celdas
        */
        UtilsTable.llenaTabla(tableList,Libros_Lista, T_LIBRO, cellAlignment, cellSize);
    }
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {                                           
        ...
        if (tableList.getSelectedRow() < 0){
            ...
            /*
                si selecciono un elemento, guarda los datos del libro en un arreglo que retornará los datos a la pantalla anterior
            */
            Libro = new Object [3];    
            // Guarda id, nombre y costo de la pelicula
            Libro [0] = Libros_Lista[tableList.getSelectedRow()][0];
            Libro [1] = Libros_Lista[tableList.getSelectedRow()][1];
            Libro [2] = Libros_Lista[tableList.getSelectedRow()][6];
