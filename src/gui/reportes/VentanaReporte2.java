...
import dataBase.ReporteLibrosView2;
import java.awt.BorderLayout;
import java.awt.Toolkit;

public class VentanaReporte2 extends javax.swing.JFrame {
    public VentanaReporte2() {
        initComponents();
        conf();
        // Configuración para cargar el reporte
        pnlReporte.setLayout(new BorderLayout());
        // Ejecuta el reporte y lo muestra en la ventana
        ReporteLibrosView2 reporte_libros2 = new ReporteLibrosView2();    
        pnlReporte.add(reporte_libros2.getReport());
    }
